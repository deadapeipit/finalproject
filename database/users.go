...
func (s *Database) Login(ctx context.Context, username string) (userid int64, resultpassword string, err error) {
...
func (s *Database) Register(ctx context.Context, i entity.UserRegister) (*entity.UserRegister, error) {
	...
	now := time.Now()
	_, err := s.SqlDb.QueryContext(ctx, qry,
